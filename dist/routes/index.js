...
const markx_action_1 = __importDefault(require("./markx-action"));
exports.default = { helloAction: hello_action_1.default, buttonAction: button_action_1.default, popupAction: popup_action_1.default, connectWallet: connect_wallet_1.default, redirect: redirect_1.default, viewEmojis: view_emojis_1.default, sendEmoji: send_emoji_1.default, markxAction: markx_action_1.default, logout: logout_1.default, help: help_1.default };
